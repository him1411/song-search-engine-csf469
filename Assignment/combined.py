...
def tf_idf_rapport(term, document_tokens, document_tokens_list):
    ...
    combined_List=[term_count(term, document_tokens),token_count(document_tokens), nr_docs_with_term(term, document_tokens_list),term_frequency(term, document_tokens), inverse_document_frequency(term, document_tokens_list),tf_idf(term, document_tokens, document_tokens_list)]
